...
let data = {axiom: ['F','-','X'], replace:{'F': ['F','F'], 'X': ['F','-','[','[','X',']','+','X',']','[','-','X','+',']','F','[','X',']','-','X'], angle:25, dist:2, startPos:[500,0]}}
...
document.addEventListener("DOMContentLoaded", function(event) { 
  ...
  let currState = {curPos: data.startPos || [0,700], stack: [], curDir: data.startDir || 0, instr: explodedInstr};
